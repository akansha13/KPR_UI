...
public class WeaverLocators {
	...
	public static String cardlist_text = "new UiSelector().className(android.widget.RelativeLayout).resourceIdMatches(\".*/layout_card_distribution\").childSelector(new UiSelector().className(android.widget.TextView).index(";
	...
	public static By registrationPage = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/signup_title\")");
	public static By registerNowButton = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_sign_up\")");
	public static By registerButton = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_register\")");
	public static By usernameRegistration = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/username\")");
	public static By mobileNoRegistration = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/mobileno\")");
	public static By emailRegistration = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/email\")");
	public static By passwordRegistration = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/password\")");
	public static By ok_RegisterButton = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_ok\")");
	public static By nickname = MobileBy.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/nickname\")");
	public static By submit_Nickname = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_submit\")");
	public static By usernameError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/username_error\")");
	public static By passwordError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/password_error\")");
	public static By emailError = MobileBy.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/email_error\")");
	public static By mobileNoError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/mobileno_error\")");
	public static By lobbyMenuButton = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_lobby_menu_icon\")");
	public static By changePasswordPage = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/title\")");
	// public static By myAccountMenuButton = MobileBy.AndroidUIAutomator("new
	// UiSelector().resourceIdMatches(\".*/drawer_listview\").childSelector(new
	...
	// public static By changePasswordButton = MobileBy.AndroidUIAutomator("new
	// UiSelector().resourceIdMatches(\".*/tv_child_text\")");
	public static By changePasswordButton = MobileBy.xpath("//android.widget.TextView[@text='Change Password']");
	public static By oldPassword = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/edt_cur_pswd\")");
	public static By newPassword = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/edt_new_pswd\")");
	public static By retypePassword = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/edt_retype_pswd\")");
	public static By ok_ChangePasswordButton = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/btn_change\")");
	public static By oldPasswordError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/cur_pswd_error\")");
	public static By newPasswordError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/new_pswd_error\")");
	public static By retypePasswordError = MobileBy
			.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/retype_pswd_error\")");
	public static By timer_1G = MobileBy.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/timer_1G\")");
	public static By extra_timer = MobileBy.AndroidUIAutomator("new UiSelector().resourceIdMatches(\".*/timerlay1G\")");
